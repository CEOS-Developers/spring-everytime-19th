...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<CommentResponseDto>> createComment(@RequestBody CommentRequestDto commentRequestDto) {
        ...
        Comment createdComment = commentService.saveComment(commentRequestDto, post);
        CommentResponseDto commentResponseDto = CommentResponseDto.createFromComment(createdComment);
    ...
    public ResponseEntity<ApiResponse<CommentResponseDto>> createCoComent(@RequestBody CommentRequestDto commentRequestDto,
                                                                          @PathVariable("commentId") Long commentId){
        Comment parentComment = commentService.findComment(commentId);
        Post post = postService.findPost(commentRequestDto.getPostId());
        Comment createdComment = commentService.saveComment(commentRequestDto, post);
        commentService.setChildComment(parentComment,createdComment);
        CommentResponseDto commentResponseDto = CommentResponseDto.createFromComment(createdComment);
